                    ...
                    <section className="border border-gray-200 rounded-lg p-5 bg-gradient-to-r from-purple-50 to-indigo-50">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <div className="text-gray-900 bg-white px-3 py-2 border rounded-md">{patientHistory.overallRisk || 'N/A'}</div>
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Heart Risk</label>
                                <div className="text-gray-900 bg-white px-3 py-2 border rounded-md">{patientHistory.heartRisk || 'N/A'}</div>
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Lung Risk</label>
                                <div className="text-gray-900 bg-white px-3 py-2 border rounded-md">{patientHistory.lungsRisk || 'N/A'}</div>
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Brain Risk</label>
                                <div className="text-gray-900 bg-white px-3 py-2 border rounded-md">{patientHistory.brainRisk || 'N/A'}</div>
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Liver Risk</label>
                                <div className="text-gray-900 bg-white px-3 py-2 border rounded-md">{patientHistory.liverRisk || 'N/A'}</div>
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Kidney Risk</label>
                                <div className="text-gray-900 bg-white px-3 py-2 border rounded-md">{patientHistory.kidneyRisk || 'N/A'}</div>
                            </div>
                            <div className="col-span-2 md:col-span-3 mt-2">
                                <label className="block text-sm font-medium text-gray-700 mb-1">Medications</label>
                                <div className="text-gray-900 bg-white px-3 py-2 border rounded-md">
